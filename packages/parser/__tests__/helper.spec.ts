import { customCreateIdentifier, customCreateNumericLiteral, customCreatePropertyAccessExpression, customTraverse } from 'Parser/lib/helper/factory';
import { CSyntaxKind } from 'Parser/lib/define';
import { CIdentifier, CModule, CNode, CPropertyAccessExpression, CStringLiteral } from 'Parser/lib/types';
