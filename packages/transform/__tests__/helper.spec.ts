import { customCreateIdentifier, customCreatePropertyAccessExpression } from 'Parser/lib/helper/factory';
import { getTypeNodesImports, transformPropertyAccessExpression, transformTypeNode } from 'Transform/lib/helper';
import { Identifier, QualifiedName, SyntaxKind, TypeReferenceNode } from 'typescript';
import { CKeyWordTypeNode, CTypeReferenceNode } from 'Parser/lib/types';
